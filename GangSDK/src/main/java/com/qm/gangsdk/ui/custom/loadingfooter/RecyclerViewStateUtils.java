package com.qm.gangsdk.ui.custom.loadingfooter;
...
public class RecyclerViewStateUtils {
    ...
    /**
     * 设置headerAndFooterAdapter的FooterView State 默认每页数据为8条
     *
     * @param instance      context
     * @param recyclerView  recyclerView
     * @param state         FooterView State
...
//        int pageSize = 18; //默认每页数据为8条
    ...
    public static boolean isScrolledBottom(RecyclerView recyclerView) {
