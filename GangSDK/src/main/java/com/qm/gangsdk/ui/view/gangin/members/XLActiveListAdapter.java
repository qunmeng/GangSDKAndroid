 ...
 */
public class XLActiveListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List list;

    public XLActiveListAdapter(Context context, List list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                holder = new ViewTopHolder(LayoutInflater.from(context).inflate(R.layout.item_recyclerview_member_active_sorttop, parent, false));
                break;
            case 1:
                holder = new ViewOtherHolder(LayoutInflater.from(context).inflate(R.layout.item_recyclerview_member_active_sortother, parent, false));
                break;
        }
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (getItemViewType(position)) {
            case 0:
                ...
                topHolder.tvNums.setText(StringUtils.getString(entity.getActivenum(), "0"));
                break;
            case 1:
                ...
                otherHolder.tvNums.setText(StringUtils.getString(entity.getActivenum(), "0"));
                break;
        }
    }
