...
//    }
     ...
     */
    public static void showConfirm(Context context, String title, CharSequence message, String okText, String cancelText, DialogInterface.OnClickListener okListener,
                                   DialogInterface.OnClickListener cancelListener) {
    ...
    public static Dialog createLoadingDialog(Context context, String msg, boolean cancelable) {
        ...
        View v = inflater.inflate(R.layout.utils_loading_dialog, null);
