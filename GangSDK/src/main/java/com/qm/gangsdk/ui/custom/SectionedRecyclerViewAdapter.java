 ...
 */
package com.qm.gangsdk.ui.custom;
 ...
 *
 * @param <H> Class extending RecyclerView.ViewOtherHolder to hold and bind the header view
 * @param <VH> Class extending RecyclerView.ViewOtherHolder to hold and bind the items view
 * @param <F> Class extending RecyclerView.ViewOtherHolder to hold and bind the footer view
 */
