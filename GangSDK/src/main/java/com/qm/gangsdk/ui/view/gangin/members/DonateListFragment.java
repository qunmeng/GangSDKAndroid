 ...
 * 版本：v1.0
 */
public class DonateListFragment extends XLBaseFragment {
    ...
    protected int getContentView() {
        return R.layout.fragment_members_contribute;
    }
    ...
    protected void initView(View view) {
        ...
        tvTitle.setText(aContext.getResources().getString(R.string.member_contribute));
    }
    ...
    private void initRecyclerView() {
        ...
        XLDonateListAdapter adapter = new XLDonateListAdapter(aContext, this.dataList);
    ...
    private void getData(final int page, int pagesize) {
        GangSDK.getInstance().groupManager().getMemberList(page, pagesize, 1, new DataCallBack<List<XLGangMemberInfoBean>>() {
